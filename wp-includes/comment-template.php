...
function comment_form_title($no_reply_text = false, $reply_text = false, $link_to_parent = true, $post = null)
{
	...
	if (false === $no_reply_text) {
		$no_reply_text = __('Dodaj komentar');
	}

	if (false === $reply_text) {
		/* translators: %s: Author of the comment being replied to. */
		$reply_text = __('Dodaj komentar to %s');
	}
 ...
 *     @type string $title_reply          The translatable 'reply' button label. Default 'Dodaj komentar'.
 *     @type string $title_reply_to       The translatable 'reply-to' button label. Default 'Dodaj komentar to %s',
...
function comment_form($args = array(), $post = null)
{
	...
	$defaults = array(
		...
		'class_submit'         => 'submit',
		'name_submit'          => 'submit',
		'title_reply'          => __('Dodaj komentar'),
		/* translators: %s: Author of the comment being replied to. */
		'title_reply_to'       => __('Dodaj komentar to %s'),
